...
describe('Value Stream Grouping', () => {
    ...
    describe('calculateGroupingBoundingBox', () => {
        it('should calculate bounding box for teams in grouping', () => {
            ...
            expect(bbox.height).toBe(239); // Now uses actual heights: both teams 64px, (200+64)-100+40+35=239
        });
        ...
        it('should handle single team', () => {
            ...
            expect(bbox.height).toBe(139); // Now uses actual height: 64 + 40 + 35 = 139
        });
        ...
        it('should handle teams with negative positions', () => {
            ...
            expect(bbox.height).toBe(239); // Now uses actual heights: (50+64)-(-50)+40+35=239
        });
    });
