...
class TestGetDataDir:
    ...
    def test_get_data_dir_tt(self):
        """Should return correct tt-teams directory based on TT_DESIGN_VARIANT env var."""
        import os
        data_dir = get_data_dir('tt')
        # Check that it's a tt-teams variant directory (respects TT_DESIGN_VARIANT env var)
        variant = os.getenv('TT_DESIGN_VARIANT', 'tt-teams')
